...
<div class="ts-row ts-gold"><span class="ts-pos">🥇</span><span class="ts-name"><a href="./Bob_Jo.html">Bob Johnson</a></span><span class="ts-pts">142 pts</span></div>
...
var data={"labels": ["2026-06-12", "2026-06-13", "2026-06-14"], "datasets": [{"label": "Bob Johnson", "data": [25.0, 47.0, 142.0], "borderColor": "#a71b1b", "backgroundColor": "rgba(167,27,27,0.08)", "tension": 0.3, "pointRadius": 5, "pointHoverRadius": 8, "borderWidth": 2.5, "fill": true}, {"label": "Carol Davis", "data": [35.0, 67.0, 119.0], "borderColor": "#1ba7a7", "backgroundColor": "rgba(27,167,167,0.08)", "tension": 0.3, "pointRadius": 5, "pointHoverRadius": 8, "borderWidth": 2.5, "fill": true}]};
...
<script>
(function(){
var d={"labels": ["Bob Johnson", "Carol Davis"], "values": [95.0, 52.0], "colors": ["#a71b1b", "#1ba7a7"], "title": "Points earned \u2192 2026-06-13 to 2026-06-14"};
