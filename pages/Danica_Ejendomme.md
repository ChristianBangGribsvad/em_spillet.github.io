...
<div class="ts-row ts-gold"><span class="ts-pos">🥇</span><span class="ts-name"><a href="./Nanna_Da.html">Nanna Davidsen</a></span><span class="ts-pts">67 pts</span></div>
...
<div class="ts-row ts-bronze"><span class="ts-pos">🥉</span><span class="ts-name"><a href="./Lucas_Ba.html">Lucas Barbera</a></span><span class="ts-pts">55 pts</span></div>
<div class="ts-row "><span class="ts-pos">4</span><span class="ts-name"><a href="./Eva_WF.html">Eva WF</a></span><span class="ts-pts">54 pts</span></div>
<div class="ts-row "><span class="ts-pos">5</span><span class="ts-name"><a href="./Christian_Gr.html">Christian Gribsvad</a></span><span class="ts-pts">40 pts</span></div>
</div>
...
var data={"labels": ["2026-06-11", "2026-06-12", "2026-06-13", "2026-06-14", "2026-06-15"], "datasets": [{"label": "Nanna Davidsen", "data": [0.0, 10.0, 29.0, 48.0, 67.0], "borderColor": "#1b53a7", "backgroundColor": "rgba(27,83,167,0.08)", "tension": 0.3, "pointRadius": 5, "pointHoverRadius": 8, "borderWidth": 2.5, "fill": true}, {"label": "Rikke Carlsen", "data": [0.0, 0.0, 20.0, 55.0, 65.0], "borderColor": "#8b1ba7", "backgroundColor": "rgba(139,27,167,0.08)", "tension": 0.3, "pointRadius": 5, "pointHoverRadius": 8, "borderWidth": 2.5, "fill": true}, {"label": "Eva WF", "data": [0.0, 5.0, 20.0, 42.0, 54.0], "borderColor": "#8ba71b", "backgroundColor": "rgba(139,167,27,0.08)", "tension": 0.3, "pointRadius": 5, "pointHoverRadius": 8, "borderWidth": 2.5, "fill": true}, {"label": "Christian Gribsvad", "data": [0.0, 12.0, 14.0, 31.0, 40.0], "borderColor": "#a71b1b", "backgroundColor": "rgba(167,27,27,0.08)", "tension": 0.3, "pointRadius": 5, "pointHoverRadius": 8, "borderWidth": 2.5, "fill": true}, {"label": "Lucas Barbera", "data": [0.0, 12.0, 24.0, 41.0, 55.0], "borderColor": "#1ba753", "backgroundColor": "rgba(27,167,83,0.08)", "tension": 0.3, "pointRadius": 5, "pointHoverRadius": 8, "borderWidth": 2.5, "fill": true}]};
...
<script>
(function(){
var d={"labels": ["Nanna Davidsen", "Lucas Barbera", "Eva WF", "Rikke Carlsen", "Christian Gribsvad"], "values": [19.0, 14.0, 12.0, 10.0, 9.0], "colors": ["#1b53a7", "#1ba753", "#8ba71b", "#8b1ba7", "#a71b1b"], "title": "Points earned \u2192 2026-06-14 to 2026-06-15"};
