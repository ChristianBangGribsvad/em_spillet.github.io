...
<div class="ts-row ts-silver"><span class="ts-pos">🥈</span><span class="ts-name"><a href="./Sarah-Alberte_Be.html">Sarah-Alberte Bennetzen</a></span><span class="ts-pts">0 pts</span></div>
</div>
...
var data={"labels": ["2026-06-11"], "datasets": [{"label": "Isabella  Isaacs", "data": [0.0], "borderColor": "#a71b1b", "backgroundColor": "rgba(167,27,27,0.08)", "tension": 0.3, "pointRadius": 5, "pointHoverRadius": 8, "borderWidth": 2.5, "fill": true}, {"label": "Sarah-Alberte Bennetzen", "data": [0.0], "borderColor": "#1ba7a7", "backgroundColor": "rgba(27,167,167,0.08)", "tension": 0.3, "pointRadius": 5, "pointHoverRadius": 8, "borderWidth": 2.5, "fill": true}]};
