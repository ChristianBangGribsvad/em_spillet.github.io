...
<div class="ts-row ts-gold"><span class="ts-pos">🥇</span><span class="ts-name"><a href="./Michael__Gr.html">Michael  Gribsvad</a></span><span class="ts-pts">135 pts</span></div>
<div class="ts-row ts-silver"><span class="ts-pos">🥈</span><span class="ts-name"><a href="./Jenus__Sa.html">Jenus  Saleh</a></span><span class="ts-pts">117 pts</span></div>
<div class="ts-row ts-bronze"><span class="ts-pos">🥉</span><span class="ts-name"><a href="./Gosia_N.html">*Gosia Jørgensen</a></span><span class="ts-pts">77 pts</span></div>
</div>
...
var data={"labels": ["2026-06-11", "2026-06-12", "2026-06-13", "2026-06-14", "2026-06-15", "2026-06-16", "2026-06-17", "2026-06-18"], "datasets": [{"label": "Michael  Gribsvad", "data": [0.0, 7.0, 32.0, 51.0, 88.0, 100.0, 100.0, 135.0], "borderColor": "#1b1ba7", "backgroundColor": "rgba(27,27,167,0.08)", "tension": 0.3, "pointRadius": 5, "pointHoverRadius": 8, "borderWidth": 2.5, "fill": true}, {"label": "Jenus  Saleh", "data": [0.0, 12.0, 29.0, 59.0, 70.0, 80.0, 85.0, 117.0], "borderColor": "#1ba71b", "backgroundColor": "rgba(27,167,27,0.08)", "tension": 0.3, "pointRadius": 5, "pointHoverRadius": 8, "borderWidth": 2.5, "fill": true}, {"label": "*Gosia J\u00f8rgensen", "data": [0.0, 10.0, 12.0, 27.0, 34.0, 41.0, 71.0, 77.0], "borderColor": "#a71b1b", "backgroundColor": "rgba(167,27,27,0.08)", "tension": 0.3, "pointRadius": 5, "pointHoverRadius": 8, "borderWidth": 2.5, "fill": true}]};
...
<script>
(function(){
var d={"labels": ["Michael  Gribsvad", "Jenus  Saleh", "*Gosia J\u00f8rgensen"], "values": [35.0, 32.0, 6.0], "colors": ["#1b1ba7", "#1ba71b", "#a71b1b"], "title": "Points earned \u2192 2026-06-17 to 2026-06-18"};
